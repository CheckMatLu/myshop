...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Mat", "http://matisthebest.superman", "matmat@mail.com");

	private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Awesome Api Title", "Awesome Api Documentation", "1.0",
